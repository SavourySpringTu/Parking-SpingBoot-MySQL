...
public class RevenueServiceImpl implements RevenueService{
	...
	@Override
	public RevenueEntity findRevenueByTime(LocalDate date) {
		for(RevenueEntity a : revenueRepository.findAll()) {
			if(a.getTime().equals(date)==true) {
				return a;
			}
		}
		return null;
	...
	public RevenueEntity updateRevenueDay() {
		...
		RevenueEntity x= findRevenueByTime(date);
		int total=0;
